                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="mx-auto col-12 col-md-8 col-lg-6">
                            <form class="form-control shadow p-4" action="index.php?r=doaddservicio" method="post">
                                <div class="mb-3 p-2">
                                    <div class="col">
                                        <label for="Nombre"> Nombre de la temporada </label>
                                        <input class="form-control" type="text" placeholder="Nombre de servicio" name="servicio">
                                    </div>
                                </div>
                               
                                <div class="mb-3 p-2">
                                    <button type="submit" class="btn btn-primary">Añadir servicio :3</button>
                                </div>
                            </form>
                        </div>
                    </div>
