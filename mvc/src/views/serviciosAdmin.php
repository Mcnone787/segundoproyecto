        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="d-flex justify-content-center align-items-center">
                    ...
                    <h3 style="text-align:center;padding:20px;">Lista de Servicios sr/sra: <?php echo $_SESSION["user"]["Nombre"] ?></h3>
                </div>
                <div class="m-3">
                    <a href="index.php?r=ctrladdservicio"><button class="btn btn-outline-success">Añadir Servicios</button></a>
                </div>
                    ...
                    <table id="myTable" class="display border rounded-2" style="width: 100%; margin-bottom: 15%; max-height: 100vh;">
                        ...
                        <tbody>
                           ...
                           foreach ($tasks as $i => $task) { ?>
                                ...
                                <tr>
                                    <td><?php echo $i + 1 ?></td>
                                    <td><?php echo $task["servicio"]; ?></td>
                                    <td>
                                        <a href="index.php?r=dodeleteservicio&id=<?php echo $task["idservicios"]; ?>"><button style="display:block;margin-bottom:10px;" class="btn btn-outline-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
