        ...
        <div class="row">
            <div class="form-inline" style="display: flex; justify-content: center;">
                <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search"
                    style="width:50%;" name="titulo" id="titulo">
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-2  row-cols-xl-4 g-4 my-5 py-3" id="cosas">
            <?php if (isset($apartamentosPagina) && is_array($apartamentosPagina)): ?>
                <?php foreach ($apartamentosPagina as $apartamento): ?>
                    ...
                    ?>
                    <div class="col">
                        <a class="link-offset-2 link-underline link-underline-opacity-0" data-bs-toggle="modal"
                            data-bs-target="#apartamentoReserva" class="stretched-link">
                            <div class="card h-100" style="width: 100%;">
                                <img src="imgs/<?php echo $imagenesjson[$apartamentoID]->src_imagen[0]; ?>" class="card-img-top"
                                    alt="...">
                                <div class="card-body">
                                    <h5 class="card-title">
                                        <?= $titulo ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col p-3 m-3 rounded-4 bg-white imgReservaBox">
                                            <div id="carouselExampleIndicators" class="carousel slide slider_modal ">
                                                    <div class="carousel-indicators" id="buttons_carr">
                                                      
                                                    </div>
                                                    <div class="carousel-inner" id="slider_modal_img">
                                        ...
                                        <div class="col p-3 m-3 rounded-4 bg-white reservabox">
                                            <div class="col mt-3 p-3">
                                                <div class="col d-flex rounded-2 p-3 m-3 text-center"
