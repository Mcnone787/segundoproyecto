<footer class="d-flex flex-wrap justify-content-between align-items-center py-3 footer_class">
    <div class="col-md-3 d-flex justify-content-center align-items-center py-3 ms-3">
        ...
        <span class="" style="font-size: 20px">© Apartaments Figueres, Inc</span>
    </div>
    <div class="col-md-2 justify-content-center py-3 my-3">
        <ul class="nav list-unlysted">
            ...
            <li class="ms-3">
                <a class="link-body-emphasis" href="https://www.x.com/">
            ...
            <li class="ms-3 nav-item">
                <a class="link-body-emphasis" href="https://www.cendrassos.net/">
