<footer class="d-flex flex-wrap justify-content-between align-items-center py-3 mt-4 footer_class">
    ...
    <div class="col-md-2 justify-content-center py-3 my-3">
        <ul class="nav list-unlysted">
            <li class="ms-3">
            ...
            <li class="ms-3">
                <a class="text-muted" href="https://www.x.com/">
            ...
            <li class="ms-3 nav-item">
                <a class="text-muted" href="https://www.cendrassos.net/">
